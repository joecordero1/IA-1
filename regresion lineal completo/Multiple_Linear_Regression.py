...
## Importar el Dataset
dataset = pd.read_csv("C:/Users/laboratorio/Downloads/50_Startups.csv")
...
y = dataset.iloc[:, 4].values ## Los dos primeros puntos : filas y los dos punto siguiente columnas
...
## Calcular el P_Valor
##para calcularlo el p valor toca onerle una columna llena de unos (1111)
